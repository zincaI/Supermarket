...
CREATE DATABASE [Supermarket4]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'Supermarket4', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL16.MSSQLSERVER\MSSQL\DATA\Supermarket4.mdf' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'Supermarket4_log', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL16.MSSQLSERVER\MSSQL\DATA\Supermarket4_log.ldf' , SIZE = 8192KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB )
 WITH CATALOG_COLLATION = DATABASE_DEFAULT
GO
ALTER DATABASE [Supermarket4] SET COMPATIBILITY_LEVEL = 140
GO
IF (1 = FULLTEXTSERVICEPROPERTY('IsFullTextInstalled'))
begin
EXEC [Supermarket4].[dbo].[sp_fulltext_database] @action = 'enable'
end
GO
ALTER DATABASE [Supermarket4] SET ANSI_NULL_DEFAULT OFF 
GO
ALTER DATABASE [Supermarket4] SET ANSI_NULLS OFF 
GO
ALTER DATABASE [Supermarket4] SET ANSI_PADDING OFF 
GO
ALTER DATABASE [Supermarket4] SET ANSI_WARNINGS OFF 
GO
ALTER DATABASE [Supermarket4] SET ARITHABORT OFF 
GO
ALTER DATABASE [Supermarket4] SET AUTO_CLOSE OFF 
GO
ALTER DATABASE [Supermarket4] SET AUTO_SHRINK OFF 
GO
ALTER DATABASE [Supermarket4] SET AUTO_UPDATE_STATISTICS ON 
GO
ALTER DATABASE [Supermarket4] SET CURSOR_CLOSE_ON_COMMIT OFF 
GO
ALTER DATABASE [Supermarket4] SET CURSOR_DEFAULT  GLOBAL 
GO
ALTER DATABASE [Supermarket4] SET CONCAT_NULL_YIELDS_NULL OFF 
GO
ALTER DATABASE [Supermarket4] SET NUMERIC_ROUNDABORT OFF 
GO
ALTER DATABASE [Supermarket4] SET QUOTED_IDENTIFIER OFF 
GO
ALTER DATABASE [Supermarket4] SET RECURSIVE_TRIGGERS OFF 
GO
ALTER DATABASE [Supermarket4] SET  DISABLE_BROKER 
GO
ALTER DATABASE [Supermarket4] SET AUTO_UPDATE_STATISTICS_ASYNC OFF 
GO
ALTER DATABASE [Supermarket4] SET DATE_CORRELATION_OPTIMIZATION OFF 
GO
ALTER DATABASE [Supermarket4] SET TRUSTWORTHY OFF 
GO
ALTER DATABASE [Supermarket4] SET ALLOW_SNAPSHOT_ISOLATION OFF 
GO
ALTER DATABASE [Supermarket4] SET PARAMETERIZATION SIMPLE 
GO
ALTER DATABASE [Supermarket4] SET READ_COMMITTED_SNAPSHOT OFF 
GO
ALTER DATABASE [Supermarket4] SET HONOR_BROKER_PRIORITY OFF 
GO
ALTER DATABASE [Supermarket4] SET RECOVERY SIMPLE 
GO
ALTER DATABASE [Supermarket4] SET  MULTI_USER 
GO
ALTER DATABASE [Supermarket4] SET PAGE_VERIFY CHECKSUM  
GO
ALTER DATABASE [Supermarket4] SET DB_CHAINING OFF 
GO
ALTER DATABASE [Supermarket4] SET FILESTREAM( NON_TRANSACTED_ACCESS = OFF ) 
GO
ALTER DATABASE [Supermarket4] SET TARGET_RECOVERY_TIME = 60 SECONDS 
GO
ALTER DATABASE [Supermarket4] SET DELAYED_DURABILITY = DISABLED 
GO
ALTER DATABASE [Supermarket4] SET ACCELERATED_DATABASE_RECOVERY = OFF  
GO
EXEC sys.sp_db_vardecimal_storage_format N'Supermarket4', N'ON'
GO
ALTER DATABASE [Supermarket4] SET QUERY_STORE = OFF
GO
USE [Supermarket4]
--creare tabele
SET ANSI_NULLS ON
...
AS
BEGIN
	select ProductID,[ProducerID],[CategoryID],[Name], [BarCode] from Product
END
...
AS
BEGIN
	select ProducerID,[Name],[Country] 
	from Producer
	where IsActive=1
END
...
AS
BEGIN
	select StockID,[ProductID],[Quantity],[Date],[SellPrice],[BuyPrice],[ExpirationDate] from Stock
END
...
AS
BEGIN
	select EmployeeID,[Name],[Password],[Type] from Employee
END
...
AS
BEGIN
	select ReceiptID,[EmployeeID],[Date] from Receipt
END
